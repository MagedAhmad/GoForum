...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 mt-12">
            <div class="card">
                <div class="card-header bg-gray-600 text-white">{{ __('Login') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <!-- <div class="form-group">
                           ...
                           <div class="col-md-6">
                               <a href="{{ url('login/facebook') }}"><span class="oi oi-facebook">Facebook</span></a>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="px-4 py-2 rounded bg-gray-600 text-white">
                                    {{ __('Login') }}
                                </button>

                                @if (Route::has('password.request'))
                                    <a class="btn btn-link text-gray-600" href="{{ route('password.request') }}">
