...
@section('content')
<div>
    <div class="bg-teal-800 md:overflow-hidden">
        ...
        <div class="md:max-w-6xl md:mx-auto">
          <div class="md:flex md:flex-wrap">
            <div class="md:w-1/2 text-center md:text-left md:pt-16">
              ...
              >
                Forum application for programmers
              </h1>

              <p class="text-indigo-200 md:text-xl md:pr-48">
                This project is built with laravel, VUE, Redis, PHPunit and tailwindcss
              </p>
